...
if (file.exists("cache/yelp_data.Rdata")){
  load("cache/yelp_data.Rdata")
  getpkgs(pkg)
} else {
  pkg <- c(pkg, "readxl")
  getpkgs(pkg)
  ...
  save(yelp_data, file="cache/yelp_data.Rdata")
}
library(ggplot2)
library(knitr)
library(dplyr)
...
if (file.exists("cache/open_qqplot.Rdata")){
  load("cache/open_qqplot.Rdata")
} else {
  ...
  save(open_qqplot, file="cache/open_qqplot.Rdata")
}
open_qqplot
...
if (file.exists("cache/closed_qqplot.Rdata")){
  load("cache/closed_qqplot.Rdata")
} else {
  ...
  save(closed_qqplot, file="cache/closed_qqplot.Rdata")
}
closed_qqplot
```
